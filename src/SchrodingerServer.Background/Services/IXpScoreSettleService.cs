...
public class XpScoreSettleService : IXpScoreSettleService, ISingletonDependency
{
    ...
    public XpScoreSettleService(ILogger<XpScoreSettleService> logger, IOptionsSnapshot<ZealyScoreOptions> options,
        ...
        INESTRepository<ZealyUserXpRecordCleanUpIndex, string> zealyUserXpRecordRepository,
    ...
    private async Task RecordBatchSettleAsync(int skipCount, List<ZealyUserXpRecordCleanUpIndex> records)
    {
    ...
    private async Task BatchSettleAsync(string bizId, List<ZealyUserXpRecordCleanUpIndex> records)
    {
